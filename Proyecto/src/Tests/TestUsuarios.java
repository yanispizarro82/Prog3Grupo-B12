...
public class TestUsuarios {
	...
	public void setUp() {
		...
		Pantalon = new CamisetasPantalones(0, "pantalon vaquero", 25.0, 1.0, "Rojo", "img/pantalon", true, Tallas.M, "Algodon", true);
		Zapatos = new Zapatos(0, "Oxford", 30, 1.3, "Azul", "img/zapatos", 42, "Cuero", true);
